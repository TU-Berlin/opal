/* hand-coded interface part of SysTime */
...
/* < */
#define ASysTime_Sl(t1,t2,r) {\
  r=pack_clean_bool(((TIME)(t1))->value < ((TIME)(t2))->value);\
  free_time(t1,1); free_time(t2,1);\
}
/* <= */
#define ASysTime_Sle(t1,t2,r) {\
  r=pack_clean_bool(((TIME)(t1))->value <= ((TIME)(t2))->value);\
  free_time(t1,1); free_time(t2,1);\
}
/* = */
#define ASysTime_Se(t1,t2,r) {\
  r=pack_clean_bool(((TIME)(t1))->value == ((TIME)(t2))->value);\
  free_time(t1,1); free_time(t2,1);\
}
/* |= */
#define ASysTime_SSe(t1,t2,r) {\
  r=pack_clean_bool(((TIME)(t1))->value != ((TIME)(t2))->value);\
  free_time(t1,1); free_time(t2,1);\
}
/* >= */
#define ASysTime_Sge(t1,t2,r) {\
  r=pack_clean_bool(((TIME)(t1))->value >= ((TIME)(t2))->value);\
  free_time(t1,1); free_time(t2,1);\
}
/* > */
#define ASysTime_Sg(t1,t2,r) {\
  r=pack_clean_bool(((TIME)(t1))->value > ((TIME)(t2))->value);\
  free_time(t1,1); free_time(t2,1);\
}
