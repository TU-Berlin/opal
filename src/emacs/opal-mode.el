...
(defvar opal-font-lock-keywords-simple
  ...
  (list
   '("\\(LAZY\\|FORCE\\|SUSPEND\\|IMPORT\\|SORT\\|FUN\\|TYPE\\|DATA\\|DEF\\|IMPLEMENTATION\\|SIGNATURE\\|EXTERNAL\\|INTERNAL\\|PROPERTIES\\|LAW\\|PROOF\\|SPC\\|PRE\\|POST\\|THEORY\\|ASSERT\\|ASSUME\\|PROP\\|JSTF\\|JUSTF\\|LEMMA\\|GOAL\\)" (0 'font-lock-function-name-face t t))
