...
operations from the predefined structures \vb{PREDEF_BOOL} and \vb{DENOTATION}.
...
With the exception of \vb{bool'PREDEF_BOOL} and \vb{denotation'DENOTATION},
...
\begin{concon}
  ...
  with the origin \tm{PREDEF_BOOL} or \tm{DENOTATION}.
...
\end{synrule}
\begin{concon}
  \item[\cs] The structures \tm{PREDEF_BOOL} and \tm{DENOTATION} are always
    imported completely.
